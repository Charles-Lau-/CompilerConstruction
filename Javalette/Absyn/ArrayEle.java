...
public class ArrayEle extends Expr {
  public final String ident_;
  public final Expr expr_;

  public ArrayEle(String p1, Expr p2) { ident_ = p1; expr_ = p2; }

  public <R,A> R accept(Javalette.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Javalette.Absyn.ArrayEle) {
      Javalette.Absyn.ArrayEle x = (Javalette.Absyn.ArrayEle)o;
