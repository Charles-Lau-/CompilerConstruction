...
public class ArrayLen extends Expr {
  public final String ident_;

  public ArrayLen(String p1) { ident_ = p1; }

  public <R,A> R accept(Javalette.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Javalette.Absyn.ArrayLen) {
      Javalette.Absyn.ArrayLen x = (Javalette.Absyn.ArrayLen)o;
