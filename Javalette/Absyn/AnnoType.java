...
public class AnnoType extends Expr {
  public final Type type_;
  public final Expr expr_;

  public AnnoType(Type p1, Expr p2) { type_ = p1; expr_ = p2; }

  public <R,A> R accept(Javalette.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Javalette.Absyn.AnnoType) {
      Javalette.Absyn.AnnoType x = (Javalette.Absyn.AnnoType)o;
